    ...
    this.content.innerHTML = `
      <row style="display: flex;">
        <div style="flex: 50%;text-align: center;">
          <img src="/local/van-tilt-card/img/vario545_side.png" style="max-width: 100%;height: 100px;transform:rotate(${yRotate}deg);">
          <hr>
          <h1>${yAngleStr}°</h1>
        </div>
        <div style="flex: 50%;text-align: center;">
          <img src="/local/van-tilt-card/img/vario545_back.png" style="max-width: 100%;height: 100px;transform:rotate(${xRotate}deg);">
          <hr>
          <h1>${xAngleStr}°</h1>
        </div>
      </row>
